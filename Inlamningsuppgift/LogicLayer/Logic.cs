...
namespace Inlamningsuppgift.LogicLayer
{
    class Logic
    {
        ...
        {
            Console.WriteLine("Choose participant to check out then press enter");
        ...
        {
            Console.WriteLine(participant.GetParticipantDetails(participant));
        ...
        {
            Console.WriteLine("Choose participant to remove then press enter");
            ...
            Participant participantToBeRemoved = participants[namePos - 1];

            participants.Remove(participantToBeRemoved);

            Console.WriteLine($"{participantToBeRemoved.FirstName} removed, press enter to return to main menu");

            MainMenu();
        }


        //Popuöates the list of participants
